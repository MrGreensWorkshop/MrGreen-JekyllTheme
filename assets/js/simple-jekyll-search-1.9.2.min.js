...
/*
  auto search while typing is disabled and
  clear search result feature when search input text is cleared
*/
...
(function () {
  ...
  (function (window) {
    ...
    function handleSubmit() {
      options.searchInput.addEventListener('input', function (e) {
        if (isWhitelistedKey(e.which)) {
          if (options.searchInput.value.length === 0) emptyResultsContainer();
        }
      });
